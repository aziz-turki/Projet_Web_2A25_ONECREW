...
function getAllEvenements(){
    ...
    function getAllParticipants(){
        ...
        function searchParticipants($keywords){
            $conn= connect ();
            $requette = "SELECT * FROM participant WHERE nomp LIKE '%$keywords%' ";
            $resultat = $conn->query($requette);
            $participants = $resultat->fetchAll();
            return $participants;
        }
...
function orderParticipantById($idp){
    $conn= connect ();
    $requette = "SELECT * FROM participant ORDER BY idp ";
    $resultat = $conn->query($requette);
    $participant = $resultat->fetch();
    return $participant;
