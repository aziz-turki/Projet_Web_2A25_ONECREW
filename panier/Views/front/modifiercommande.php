...
!empty($_POST['ville'])
            ...
            $commande = new commande($_POST['num'],
            $_POST['nom'],
            $_POST['prenom'], 
            $_POST['telephon'],
            $_POST['email'],
...
<!---------------------------------------------------------------------------------------------------------------------->
    ...
    <body>
		...
		<?php
			if (isset($_POST['num'])){
				$commande = $commandec->recuperercommande($_POST['num']);
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    ...
                    <td><input type="number" name="num" id="num" value="<?php echo $commande['num']; ?>"></td>
                </tr>
				<tr>
                    <td>
                        <label for="nom">nom:
                    ...
                    <td><input type="text" name="nom" id="nom" value="<?php echo $commande['nom']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="prenom" id="prenom" value="<?php echo $commande['prenom']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="number" name="telephon" id="telephon" value="<?php echo $commande['telephon']; ?>"></td>
                </tr>   
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="email" id="email" value="<?php echo $commande['email']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="adress" id="adress" value="<?php echo $commande['adress']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="region" id="region" value="<?php echo $commande['region']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="ville" id="ville" value="<?php echo $commande['ville']; ?>" maxlength="20"></td>
                </tr>
                    <td></td>
                    <td>
