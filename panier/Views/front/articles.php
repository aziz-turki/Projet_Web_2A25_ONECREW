        ...
        <?php 
          ...
          <div class="col-md-4 ftco-animate">
	          <div class="block-7">
	            ...
	            <h2 class="heading"><?php echo $article['nom'] ?></h2>
	            <span class="price"> <span class="number"><img src="<?php echo $article['image'] ?> " width="100" height="100" ></span></span>
	            <span class="excerpt d-block"><sup>$</sup><?php echo $article['prix'] ?></span>
	            
	            <h3 class="heading-2 my-4"><?php echo $article['description'] ?></h3>
	            
	            <ul class="pricing-text mb-5">
	              <li><?php echo $article['categorie'] ?></li>
                <a href=""><li>add to favorites</li></a>
	            </ul>
              <div class="row">
              
              <a href="ajouterPanierLine.php?prix=<?php echo $article['prix'] ?>&nom_produit=<?php echo $article['nom'] ?>" class="btn btn-primary  d-block px-2 py-4">buy</a>
              </div>
